document.addEventListener('DOMContentLoaded', () => {
  ...
  desc:'Её блокноты повидали коллажи не только из наклеек, но и из чайных пакетиков, вырезок, упаковок, шерсти кота...'
    ...
    {
  name:'Озоныш',
  img:'../images/ozonysh.webp',
  category:'fan',
  date:'2025-12-09',
  author:'Автор: Алиса М.',
  desc:'Счастливый и наивный, только что получивший новую партию тарников, которые придут в негодность  в этот же день, вдохновленный своей работой Озоныш вновь спешит покорять дороги, чтобы доставить заказики в срок.'
},
    {
  name:'Бигбосыш',
  img:'../images/bigbosysh.webp',
  category:'fan',
  date:'2025-12-09',
  author:'Автор: Ксения Панова',
  desc:'When you can\'t even say my name'
}
